...
export const useTriggers = (id: string) => {
  ...
  return { types, onSetTrigger, isPending, onSaveTrigger };
};
...
export const useAutomationPosts = (id: string) => {
    const [posts, setPosts] = useState<AutomationPosts[]>([]);

    const onSelectPost = (post: AutomationPosts) => {
        setPosts((prevItems) => {
