  ...
  return (
    <div className="bg-background-80 p-3 rounded-xl w-full">
        ...
        <p className="text-text-secondary">
            {type === 'COMMENT' 
                ?   'If the user comment on a video that is setup to listen for keywords, this automation will fire'
                : 'If the user send you a message that contains keyowords, this automation will fire'
            }
        </p>
